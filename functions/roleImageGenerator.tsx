...
const citizenEn = require("../assets/citizen-en.webp");
const mafiaEn = require("../assets/mafia-en.webp");
const donEn = require("../assets/don-en.webp");
const doctorEn = require("../assets/doctor-en.webp");
const sherifEn = require("../assets/sherif-en.webp");
const killerEn = require("../assets/killer-en.webp");
